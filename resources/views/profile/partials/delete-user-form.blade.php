<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta che il tuo account verrà eleminato, tutti i tuoi dati verranno cancellati permanentemente.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Sei sicuro di vole eliminare il tuo Account?') }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta che elimini il tuo account, tutti i dati relativi ad esso verranno definitivamente cancellati. Conferma di voler eliminare il tuo account inserendo la password.') }}
                    </p>
                </div>
